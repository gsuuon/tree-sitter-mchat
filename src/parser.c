...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__message_separator, 2, 0, 0),
  [66] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__message_separator, 2, 0, 0),
